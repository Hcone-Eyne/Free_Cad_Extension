...
# ── Source file locations (generated by AI runner) ────────────────────────────
_step_file = ai_gen_folder / "model.step"
_obj_file  = ai_gen_folder / "model.obj"

# ── Blender executable — adjust if installed elsewhere ────────────────────────
_BLENDER_CMD = "/Applications/Blender.app/Contents/MacOS/Blender"
...
def export_to_freecad(mode: str = "save"):
    ...
    if mode == "import":
        # Launch FreeCAD and open the step file directly
        try:
            subprocess.Popen([
            ...
            _show_message("FreeCAD Not Found",
                          "FreeCAD.app was not found at /Applications/FreeCAD.app.\n"
                          "Falling back to Finder reveal.", "error")
            _reveal_in_finder(_step_file)
            return False
...
def export_to_blender(mode: str = "save"):
    ...
    if mode == "import":
        ...
        blender_import_script.write_text(f"""\
import bpy
...
""")
        try:
            ...
            _show_message("Blender Not Found",
